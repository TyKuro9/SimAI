...
workload=${base}/my_workloads/H100-gpt_22B-world_size1024-tp8-pp4-ep1-gbs768-mbs1-seq2048-MOE-False-GEMM-False-flash_attn-True.txt
topology_dir=${base}/mytopo/1024_12p8T
output=${FLOWSIM_OUTPUT:-${base}/experiments/flowsim_spray/adaptive_dense_1024_ga24_fanoutfix_20260718}
